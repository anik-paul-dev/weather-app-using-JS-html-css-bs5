document.getElementById('getWeather').addEventListener('click', async () => {
    ...
    const apiKey = '0b90e35115aafae63d2ae348257d076c'; // Replace with your actual OpenWeatherMap API key

    weatherDetails.innerHTML = ''; // Clear previous data

    if (city === '') {
        weatherDetails.innerHTML = '<p class="text-danger text-center">Please enter a city name.</p>';
        return;
    }
    ...
    try {
        ...
        // Background image and color change based on weather condition
